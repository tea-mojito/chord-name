...
export const BASE_PATTERNS = [
  { name: "", core: [0, 4, 7], opt: [], deg: [0, 2, 4], description: "Major triad" },
  { name: "m", core: [0, 3, 7], opt: [], deg: [0, 2, 4], description: "Minor triad" },
  ...
  { name: "6", core: [0, 4, 7, 9], opt: [], deg: [0, 2, 4, 5], description: "Major sixth" },
  { name: "m6", core: [0, 3, 7, 9], opt: [], deg: [0, 2, 4, 5], description: "Minor sixth" },
  { name: "7", core: [0, 4, 7, 10], opt: [], deg: [0, 2, 4, 6], description: "Dominant seventh" },
  ...
  { name: "Δ7", core: [0, 4, 7, 11], opt: [], deg: [0, 2, 4, 6], description: "Major seventh" },
  { name: "m7", core: [0, 3, 7, 10], opt: [], deg: [0, 2, 4, 6], description: "Minor seventh" },
  ...
  { name: "mΔ7", core: [0, 3, 7, 11], opt: [], deg: [0, 2, 4, 6], description: "Minor major seventh" }
];

/* ================= TENSION PATTERNS ================= */
export const TENSION_PATTERNS = [
  // Minor family
  { name: "m9", core: [0, 3, 7, 10, 14], opt: [], deg: [0, 2, 4, 6, 1], description: "Minor ninth" },
  { name: "m11", core: [0, 3, 7, 10, 14, 17], opt: [], deg: [0, 2, 4, 6, 1, 3], description: "Minor eleventh" },
  { name: "m13", core: [0, 3, 7, 10, 14, 17, 21], opt: [], deg: [0, 2, 4, 6, 1, 3, 5], description: "Minor thirteenth" },
  { name: "m6/9", core: [0, 3, 9, 14], opt: [7], deg: [0, 2, 5, 1, 4], description: "Minor six nine (5th optional)" },

  // Dominant family
  { name: "9", core: [0, 4, 7, 10, 14], opt: [], deg: [0, 2, 4, 6, 1], description: "Dominant ninth" },
  ...
  { name: "9(#11)", core: [0, 4, 7, 10, 14, 18], opt: [], deg: [0, 2, 4, 6, 1, 3], description: "Dominant nine sharp eleven" },
  { name: "11", core: [0, 4, 7, 10, 14, 17], opt: [], deg: [0, 2, 4, 6, 1, 3], description: "Dominant eleventh" },
  { name: "13", core: [0, 4, 7, 10, 14, 17, 21], opt: [], deg: [0, 2, 4, 6, 1, 3, 5], description: "Dominant thirteenth" },
  { name: "13(b5)", core: [0, 4, 6, 10, 14, 17, 21], opt: [], deg: [0, 2, 4, 6, 1, 3, 5], description: "Dominant thirteen flat five" },
  { name: "13(#5)", core: [0, 4, 8, 10, 14, 17, 21], opt: [], deg: [0, 2, 4, 6, 1, 3, 5], description: "Dominant thirteen sharp five" },

  // Major family
  { name: "Δ9", core: [0, 4, 7, 11, 14], opt: [], deg: [0, 2, 4, 6, 1], description: "Major ninth" },
  { name: "Δ11", core: [0, 4, 7, 11, 14, 17], opt: [], deg: [0, 2, 4, 6, 1, 3], description: "Major eleventh" },
  { name: "Δ13", core: [0, 4, 7, 11, 14, 17, 21], opt: [], deg: [0, 2, 4, 6, 1, 3, 5], description: "Major thirteenth" },

  // Minor major family
  { name: "mΔ9", core: [0, 3, 7, 11, 14], opt: [], deg: [0, 2, 4, 6, 1], description: "Minor major ninth" },
  { name: "mΔ11", core: [0, 3, 7, 11, 14, 17], opt: [], deg: [0, 2, 4, 6, 1, 3], description: "Minor major eleventh" },
  { name: "mΔ13", core: [0, 3, 7, 11, 14, 17, 21], opt: [], deg: [0, 2, 4, 6, 1, 3, 5], description: "Minor major thirteenth" }
];
